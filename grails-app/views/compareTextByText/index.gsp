...
<html>
    ...
    <body>
        ...
        <div class="container ">
            <h1 class="main-title"><g:message code="default.compareTextByText.label"/></h1>

            <g:form controller="compareTextByText" action="inputFileExcel" method="POST" enctype="multipart/form-data"
                    class="js-excel-upload__form"
                    data-status-url="${createLink(controller: 'compareTextByText', action: 'importStatus')}">
                <div>
                ...
                <div>
                    <div>
                        <label class="font-weight-bold" for="fileExcel"><g:message code="default.excelFile.label"/></label
                    </div>
                    <div>
